...
public class ECPoint
{
    ...
    public static ECPoint operator +(ECPoint p1, ECPoint p2)
    {
        ...
        BigInteger m = (dy * program.ModInverse(dx, p1.FieldChar)) % p1.FieldChar;
        if (m < 0)
            m += p1.FieldChar;
    ...
    public static ECPoint Double(ECPoint p)
    {
        ...
        BigInteger m = (dy * program.ModInverse(dx, p.FieldChar)) % p.FieldChar;
...
public class program
{
    ...
    const string b = "43308876546767276905765904595650931995942111794451039583252968842033849580414";

    const string m = "57896044618658097711785492504343953927082934583725450622380973592137631069619";


    const string xp = "2";

    const string yp = "4018974056539037503335449422937059775635739389905545080690979365213431566280";

    const string d = "55441196065363246126355624130324183196576709222340016572108097750006097525544";

    const string xq = "57520216126176808443631405023338071176630104906313632182896741342206604859403";
    const string yq = "17614944419213781543809391949654080031942662045363639260709847859438286763994";
    ...
    static void Main()
    {
        ...
        byte[] message ={
                            ...
                            0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,
                            0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,
                            0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,
                            0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,
                            0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,
        ...
        byte[] res2 = G256.GetHash(message);
        ...
        var p = BigInteger.Parse("57896044618658097711785492504343953926634992332820282019728792003956564821041");

    var G = new ECPoint
        {
            a = BigInteger.Parse(a),
            b = BigInteger.Parse(b),
            x = BigInteger.Parse(xp),
            y = BigInteger.Parse(yp),
            FieldChar = p
        ...
        var d = BigInteger.Parse(program.d);
        ...
        var Q = new ECPoint
        {
            a = BigInteger.Parse(a),
            b = BigInteger.Parse(b),
            x = BigInteger.Parse(xq),
            y = BigInteger.Parse(yq),
            FieldChar = p
        ...
        string Rvector = padding(BitConverter.ToString(r.ToByteArray()), (int)p.GetBitLength() / 4);
        string Svector = padding(BitConverter.ToString(s.ToByteArray()), (int)p.GetBitLength() / 4);

        var sign = Rvector + "-" + Svector;
